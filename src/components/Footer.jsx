    ...
    <footer className={`relative overflow-hidden mt-12 ${
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center space-y-6">
          ...
          <div className="grid md:grid-cols-2 gap-4 max-w-2xl mx-auto">
            ...
            <div className={`p-4 rounded-xl border-2 ${
              ...
              <div className="flex items-center justify-center gap-2 mb-2">
                <Database className={`w-4 h-4 ${darkMode ? 'text-emerald-400' : 'text-emerald-600'}`} />
              ...
              <a
                ...
                className="inline-flex items-center gap-1 text-emerald-600 hover:text-emerald-700 font-semibold transition-all duration-300 hover:scale-105"
              >
                Quran.com
            ...
            <div className={`p-4 rounded-xl border-2 ${
              ...
              <div className="flex items-center justify-center gap-2 mb-2">
                <Code className={`w-4 h-4 ${darkMode ? 'text-emerald-400' : 'text-emerald-600'}`} />
                <p className={`text-sm font-semibold ${darkMode ? 'text-gray-300' : 'text-gray-700'}`}>
                  API Documentation
                </p>
              </div>
          ...
          {/* Divider */}
          <div className={`border-t-2 ${darkMode ? 'border-gray-700' : 'border-gray-200'} pt-6`}>
            {/* Copyright */}
            <p className={`text-sm font-medium ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>
              © {new Date().getFullYear()} Al-Quran Digital
            </p>
            <p className={`text-xs mt-1 ${darkMode ? 'text-gray-500' : 'text-gray-500'}`}>
              Developed by <span className="font-semibold text-emerald-600">Aji Prasetia</span>
            </p>
          </div>
        </div>
      </div>
